...
class CompositeServiceApplicationTests {
  ...
  @MockBean
  private ProductCompositeIntegrationService compositeIntegration;
  ...
  void getProductById() {
    ...
    client.get()
            .uri("v1/product-composite/" + PRODUCT_ID_OK)
  ...
  void getProductNotFound() {
    ...
    client.get()
            .uri("v1/product-composite/" + PRODUCT_ID_NOT_FOUND)
            .accept(APPLICATION_JSON)
            .exchange()
  ...
  void getProductInvalidInput() {
    ...
    client.get()
            .uri("v1/product-composite/" + PRODUCT_ID_INVALID)
            .accept(APPLICATION_JSON)
            .exchange()
